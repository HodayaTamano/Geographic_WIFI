...
public class KML_by_lib {
	...
	public static void main(String[] args) throws FileNotFoundException{
		String path ="C:/Users/Leandrog/git/GW2/Input Files/all_data.csv"; //change path here <--
	 ...
	 * @param filter_ID String of ID wanted.
	 ...
	 * 
	 * @param data_kml arraylist of rows.
	 * @param filter_begin Time wanted to begin filtering from.
	 * @param filter_end Time wanted to end filtering.
	 * @throws FileNotFoundException file was not found.
	 */
	 ...
	 * @param w - Wifi object
	 * @return boolean if wifi should be deleted.
	 */
	...
	public static void kml_file(ArrayList <Row> table)throws FileNotFoundException{
		...
		// print and save
		kml.marshal(new File("C:/Users/Leandrog/git/GW2/Input Files/general_kml.kml")); //change path here <--
	}
