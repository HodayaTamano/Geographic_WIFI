...
public class Csv {
	...
	public static void main(String[] args) {
		...
		String path ="C:/Users/Leandrog/git/GW2/Input Files"; //change path here <-
		...
		pass_to_file(data_csv, "C:/Users/Leandrog/git/GW2/Input Files/all_data.csv"); //change path here <--
	}
	
	/**
	 * This method makes a copy of an ArrayList of Row objects.
	 * @param original original Row arraylist.
	 * @return A copy of the list sent.
	 */
